    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            AppDomain.CurrentDomain.UnhandledException += (sender, args) =>
            {
                ...
                {
                    Log.Error("Unhandled exception caught by AppDomain", ex);
                }
            };
        ...
        {
            Console.Title = $"NosEmu | Game Server | Channel: {Environment.GetEnvironmentVariable("GAME_SERVER_CHANNEL_ID")}";
            const string text = @"

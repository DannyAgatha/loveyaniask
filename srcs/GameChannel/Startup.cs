...
using NosEmu.Plugins.BasicImplementations;
using NosEmu.Plugins.BasicImplementations.Algorithms;
using NosEmu.Plugins.BasicImplementations.BCards;
...
namespace GameChannel
{
    public class Startup
    {
        private static ServiceProvider GetPluginsProvider()
        {
            ...
            pluginBuilder.AddTransient<IGameServerPlugin, SkillPluginCore>();
            ...
            pluginBuilder.AddTransient<IGameServerPlugin, LandOfDeathPluginCore>();
            pluginBuilder.AddTransient<IGameServerPlugin, AlzanorPluginCore>();
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IGamePlugin, SkillPlugin>();
            ...
            services.AddTransient<IGamePlugin, LandOfDeathPlugin>();
            services.AddTransient<IGamePlugin, AlzanorPlugin>();
        }

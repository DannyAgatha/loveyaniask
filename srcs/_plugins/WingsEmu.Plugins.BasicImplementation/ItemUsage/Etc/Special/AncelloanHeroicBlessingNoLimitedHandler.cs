...
public class AncelloanHeroicBlessingNoLimitedHandler : IItemHandler
{
    private const int CARD_ID = 4662;
    private readonly IBuffFactory _buffFactory;
    private readonly IGameLanguageService _gameLanguage;

    public AncelloanHeroicBlessingNoLimitedHandler(IGameLanguageService gameLanguage, IBuffFactory buffFactory)
    {
    ...
    public long[] Effects => new long[] { 30032 };

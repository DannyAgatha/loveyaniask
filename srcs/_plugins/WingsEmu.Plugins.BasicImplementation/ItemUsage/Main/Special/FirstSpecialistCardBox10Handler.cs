...
public class FirstSpecialistCardBox10Handler : IItemHandler
{
    private readonly IGameItemInstanceFactory _gameItemInstanceFactory;
    
    public FirstSpecialistCardBox10Handler(IGameItemInstanceFactory gameItemInstanceFactory) => _gameItemInstanceFactory = gameItemInstanceFactory;
    public ItemType ItemType => ItemType.Special;
    public long[] Effects => new long[] { 30004 };
    ...
    public async Task HandleAsync(IClientSession session, InventoryUseItemEvent e)
    {
        ...
        {
            { ClassType.Swordman, 901},
            { ClassType.Archer, 903},
            { ClassType.Magician, 905}
        };

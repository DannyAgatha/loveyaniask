...
public class SeraphicTropicaneChestHandler : IItemHandler
{
    private readonly IGameItemInstanceFactory _gameItemInstanceFactory;
    
    public SeraphicTropicaneChestHandler(IGameItemInstanceFactory gameItemInstanceFactory) => _gameItemInstanceFactory = gameItemInstanceFactory;
    public ItemType ItemType => ItemType.Special;
    public long[] Effects => new long[] { 30026 };
    ...
    public async Task HandleAsync(IClientSession session, InventoryUseItemEvent e)
    {
        ...
        {
            { ClassType.Swordman, 30265 },
            { ClassType.Archer, 30266 },
            { ClassType.Magician, 30267 }
        };

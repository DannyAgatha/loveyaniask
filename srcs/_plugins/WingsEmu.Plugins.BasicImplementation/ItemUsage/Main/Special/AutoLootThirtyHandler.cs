...
public class AutoLootThirtyHandler : IItemHandler
{
    private readonly IGameLanguageService _gameLanguage;

    public AutoLootThirtyHandler(IGameLanguageService gameLanguage) => _gameLanguage = gameLanguage;

    public ItemType ItemType => ItemType.Special;
    public long[] Effects => [20004];

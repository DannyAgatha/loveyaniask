...
public class SecondSpecialistCardBox10Handler : IItemHandler
{
    private readonly IGameItemInstanceFactory _gameItemInstanceFactory;
    
    public SecondSpecialistCardBox10Handler(IGameItemInstanceFactory gameItemInstanceFactory) => _gameItemInstanceFactory = gameItemInstanceFactory;
    public ItemType ItemType => ItemType.Special;
    public long[] Effects => new long[] { 30005 };
    ...
    public async Task HandleAsync(IClientSession session, InventoryUseItemEvent e)
    {
        ...
        {
            { ClassType.Swordman, 902 },
            { ClassType.Archer, 904 },
            { ClassType.Magician, 906 }
        };

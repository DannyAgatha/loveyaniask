...
public class AutoLootOneDayHandler : IItemHandler
{
    private readonly IGameLanguageService _gameLanguage;

    public AutoLootOneDayHandler(IGameLanguageService gameLanguage) => _gameLanguage = gameLanguage;

    public ItemType ItemType => ItemType.Special;
    public long[] Effects => [20001];

...
public class AutoLootSevenDaysHandler : IItemHandler
{
    private readonly IGameLanguageService _gameLanguage;

    public AutoLootSevenDaysHandler(IGameLanguageService gameLanguage) => _gameLanguage = gameLanguage;

    public ItemType ItemType => ItemType.Special;
    public long[] Effects => [20002];

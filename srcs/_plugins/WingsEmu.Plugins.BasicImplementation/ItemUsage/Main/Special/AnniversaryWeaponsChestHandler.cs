...
public class AnniversaryWeaponsChestHandler : IItemHandler
{
    private readonly IGameItemInstanceFactory _gameItemInstanceFactory;
    
    public AnniversaryWeaponsChestHandler(IGameItemInstanceFactory gameItemInstanceFactory) => _gameItemInstanceFactory = gameItemInstanceFactory;
    public ItemType ItemType => ItemType.Special;
    public long[] Effects => new long[] { 30033 };
    ...
    public async Task HandleAsync(IClientSession session, InventoryUseItemEvent e)
    {
        ...
        {
            { ClassType.Swordman, 30802 }, // 10th Anniversary Cake Knife Skin [V1]
            { ClassType.Archer, 30803 }, // 10th Anniversary Cake Skin [V1]
            { ClassType.Magician, 30804 } // 10th Anniversary Cake Skin [V1]
        };

...
public class FriendshipMedalHandler : IItemHandler
{
    private readonly IGameLanguageService _gameLanguage;

    public FriendshipMedalHandler(IGameLanguageService gameLanguage) => _gameLanguage = gameLanguage;

    public ItemType ItemType => ItemType.Special;
    public long[] Effects => new long[] { 205 };
    ...
    public async Task HandleAsync(IClientSession session, InventoryUseItemEvent e)
    {
        ...
        DateTime? effectDateEnd = DateTime.UtcNow.AddDays(10);
        ...
        await session.EmitEventAsync(new AddStaticBonusEvent(new CharacterStaticBonusDto
        {
            ...
            StaticBonusType = StaticBonusType.FriendshipMedal
        }));

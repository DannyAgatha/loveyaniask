...
namespace Plugin.Database.Migrations
{
    ...
    [Migration("20250815094037_AddWorldBossRecords")]
    partial class AddWorldBossRecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Plugin.Database.Entities.Account.RefreshTokensEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Plugin.Database.Entities.PlayersData.DbCharacter", b =>
                {
                    ...
                    b.Property<List<BattlePassItemDto>>("BattlePassItemDto")
                        .HasColumnType("jsonb");

                    b.Property<BattlePassOptionDto>("BattlePassOptionDto")
                        .HasColumnType("jsonb");

                    b.Property<List<BattlePassQuestDto>>("BattlePassQuestDto")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<CharacterCookingDto>>("CharacterCookingDto")
                        .HasColumnType("jsonb");

                    b.Property<CharacterPrestigeDto>("CharacterPrestigeDto")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<DailyRewardDto>>("DailyRewardDto")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<CharacterFishDto>>("FishDto")
                        .HasColumnType("jsonb");

                    b.Property<List<CharacterFishRewardsEarnedDto>>("FishRewardsEarnedDto")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<bool>("HideCD")
                        .HasColumnType("boolean");

                    b.Property<bool>("HideHPMP")
                        .HasColumnType("boolean");
                    ...
                    b.Property<IcebreakerLeaverBusterDto>("IcebreakerLeaverBusterDto")
                        .HasColumnType("jsonb");

                    b.Property<List<CharacterInventoryItemDto>>("Inventory")
                        .HasColumnType("jsonb");

                    b.Property<bool>("IsAvailableToChangeName")
                        .HasColumnType("boolean");
                    ...
                    b.Property<CharacterItemRestrictionDto>("ItemRestrictionDto")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<MaxStarTrainerDto>>("MaxStarTrainerDto")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<CharacterPityDto>>("PityDto")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<long>("TierExperience")
                        .HasColumnType("bigint");
                    ...
                    b.Property<List<TrainerQuestDto>>("TrainerQuestDto")
                        .HasColumnType("jsonb");

                    b.Property<CharacterTrophyFragmentsDto>("TrophyFragmentsDto")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<WorldBossRecordDto>>("WorldBossRecordsDto")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Plugin.Database.Families.DbFamily", b =>
                {
                    ...
                    b.Property<FamilyRankingDto>("CurrentDayRankStat")
                        .HasColumnType("jsonb");

                    b.Property<FamilyRankingDto>("CurrentMonthRankStat")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<FamilyRankingDto>("GlobalRankStat")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<FamilyRankingDto>("PreviousMonthRankStat")
                        .HasColumnType("jsonb");

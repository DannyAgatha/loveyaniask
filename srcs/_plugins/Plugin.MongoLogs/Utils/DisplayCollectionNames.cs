namespace Plugin.MongoLogs.Utils
{
    public static class DisplayCollectionNames
    {
        ...
        /* HEROIC LEVEL UPS */
        public const string HEROIC_LEVEL_UP_NOSMATE = "Heroic Level Up NosMate";
        ...
        /* ICEBREAKER */
        public const string ICEBREAKER_MANAGEMENT_WON = "Icebreaker Won";
        public const string ICEBREAKER_MANAGEMENT_LOSE = "Icebreaker Lose";
        public const string ICEBREAKER_MANAGEMENT_JOIN = "Icebreaker Join";
        public const string ICEBREAKER_MANAGEMENT_FROZEN = "Icebreaker Frozen";

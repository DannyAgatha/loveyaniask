...
public enum Game18NConstString : short
{
    ...
    // <summary>
    WoundedAsgobasDisappeared = 2566,
    ...
    // <summary>
    RevitalisedAsgobasHunting = 2570,
    ...
    // <summary>
    NoOtherActionsCanBeCarriedOutWhileCasting = 2615,

    // <summary>
    // Highest star rating already reached.
    // <summary>
    HighestStarReached = 2616,

    // <summary>
    // Cannot be used on pets without a star rating.
    // <summary>
    CannotBeUsedOnPetsWitoutStar = 2617,

    // <summary>
    // Star rating increased to %d
    // <summary>
    StarIncreasedTo = 2618,

    // <summary>
    // Training level reset to %d
    // <summary>
    TrainingLevelResetTo = 2619,
    ...
    // <summary>
    ConfirmTrainingReset = 2629,

    // <summary>
    // The pet's training is already at 0.
    // <summary>
    TrainingLevelAlreadyAtZero = 2630,
    ...
    // <summary>
    CanOnlyResetPetsReachedMaximumTrainingLevel = 2639,

    // <summary>
    // Can only contain 6-star pets.
    // <summary>
    CanOnlyContainSixStarPet = 2640,

    // <summary>
    // [%s] has reached the maximum training level.
    // <summary>
    HasReachedMaximumTrainingLevel = 2641,

    // <summary>
    // %s has completed a Pet Book mission and received {%s}.
    // <summary>
    HasCompletedPetBookMissionAndReceived = 2642,

    // <summary>
    // %s has successfully increased the star rating of %s to 6 stars.
    // <summary>
    HasIncreasedStarTo6 = 2643,

    // <summary>
    // %s has successfully upgraded {%s} to +%s.
    // <summary>
    HasSuccessfullyUpgraded = 2644,
    ...
    // <summary>
    IfPutOnBeadKeepStarButResetTrainingLevel = 2645,
    ...
    // <summary>
    NosMateDoesNotHaveSummoningBook = 2647,

    // <summary>
    // You have removed the NosMate Summoning Book effect from %s.
    // <summary>
    RemovedNosMatesSummoningBookFrom = 2648,

    // <summary>
    // This fairy already has the max. upgrade level and cannot be upgraded any further.
    // <summary>
    FairyMaxUpgradeLevelReached = 2649,

    // <summary>
    // The update has failed. The materials have been consumed.
    // <summary>
    UpdateFailedMaterialsConsumed = 2650,

    // <summary>
    // %s has successfully been levelled up to +%d.
    // <summary>
    SuccessfullyLevelledUp = 2651,

    // <summary>
    // You can try it with +1 fairies or higher.
    // <summary>
    TryWithHigherFairies = 2652,

    // <summary>
    // The fairy is bound to someone else. Betting is only possible with own fairies.
    // <summary>
    FairyBoundToOthersBetOnlyOwn = 2653,

    // <summary>
    // The fairy is bound to someone else. Levelling up is only possible with own fairies.
    // <summary>
    FairyBoundToOthersLevelUpOwn = 2654,
    ...
    // <summary>
    CannotUseFairyRestorationSet = 2656,

    // <summary>
    // The fairy level has been reduced by 1 and the latest effect removed.
    // <summary>
    FairyLevelReducedBy1EffectRemoved = 2657,
    ...
    // <summary>
    FairyBoundToOthersUseRestorationSetOwn = 2659,

    // <summary>
    // The below effect will be deleted and the fairy level reduced by 1. Are you sure?
    // <summary>
    ConfirmEffectDeletedFairyLevelReduced = 2660,

    // <summary>
    // The level of %s has been reduced to +%d and the below effect has been removed.
    // <summary>
    FairyLevelReducedEffectRemoved = 2661,

    // <summary>
    // The fairy has become overcharged. Use %s before you make your next attempt.
    // <summary>
    FairyOverchargedUseBeforeNextAttempt = 2662,

    // <summary>
    // The upgrade has failed but the fairy was not overcharged thanks to the %s.
    // <summary>
    UpgradeFailedFairyNotOvercharged = 2663,

    // <summary>
    // The upgrade has failed and the fairy has become overcharged. Cannot be upgraded further.
    // <summary>
    UpgradeFailedFairyOvercharged = 2664,

    // <summary>
    // Can only be used on overcharged fairies.
    // <summary>
    UseOnlyOnOverchargedFairies = 2665,
    ...
    // <summary>
    ChampionLevel60Required = 2669,

    // <summary>
    // The Fairy Reset Hammer cannot be used on this item.
    // </summary>
    FairyResetHammerNotUsable = 2700,

    // <summary>
    // The fairy's level and effects will be reset. Do you wish to use the Fairy Reset Hammer?
    // </summary>
    FairyResetHammerConfirm = 2701,

    // <summary>
    // The fairy's level and effects have been reset.
    // </summary>
    FairyResetHammerApplied = 2702,

    // <summary>
    // The following effect will be removed. Do you want to continue anyway?
    // </summary>
    EffectRemovalConfirmation = 2703,

    // <summary>
    // Can be entered after completing all low-level Time-Spaces in the Act.
    // </summary>
    TimeSpaceCompletionRequired = 2704,

    // <summary>
    // Restored Asgobas has started hunting!
    // </summary>
    RestoredAsgobasHunting = 2705,
    ...
    // </summary>
    BossAppearedInArea3 = 2707,

    // <summary>
    // Team A has secured area %d.
    // </summary>
    TeamASecuredArea = 2708,

    // <summary>
    // Team B has secured area %d.
    // </summary>
    TeamBSecuredArea = 2709,

    // <summary>
    // The portal to the boss will open soon. Get ready!
    // </summary>
    BossPortalOpeningSoon = 2710,

    // <summary>
    // The portal to the lab where Ultimate Giant Arma is located is now open.
    // </summary>
    UltimateGiantArmaLabOpen = 2711,

    // <summary>
    // The raid in area %d starts soon. Defeat all the monsters there.
    // </summary>
    RaidStartingInArea = 2712,

    // <summary>
    // Area %d is secure. The portal to area %d will open soon.
    // </summary>
    AreaSecuredPortalOpening = 2713,

    // <summary>
    // Do you want to change the colour of your Mecha Flame Wings?
    // </summary>
    ChangeMechaFlameWingsColor = 2714,

    // <summary>
    // The Fairy Effect Lock cannot be used with this item.
    // </summary>
    FairyEffectLockNotUsable = 2715,

    // <summary>
    // The fairy is bound to someone else. The Fairy Effect Lock can only be used on your own fairies.
    // </summary>
    FairyEffectLockBoundToOther = 2716,

    // <summary>
    // Do you want to use the Fairy Effect Lock to keep one of the fairy's effects when enchanting?
    // </summary>
    UseFairyEffectLock = 2717,

    // <summary>
    // Cannot be used as the effect is already locked.
    // </summary>
    EffectAlreadyLocked = 2718,

    // <summary>
    // The following effect has been locked by the Fairy Effect Lock.
    // </summary>
    FairyEffectLocked = 2719,

    // <summary>
    // Raid completion reward (Fairy XP %d).
    // </summary>
    RaidCompletionFairyXPReward = 2720,

    // <summary>
    // Attempt to upgrade %s (%s) to (%s). Do you want to continue?
    // </summary>
    UpgradeAttempt = 2721,

    // <summary>
    // Successfully upgraded to %s (%s).
    // </summary>
    UpgradeSuccess = 2722,
    ...
    // <summary>
    // %s's team has completed the %s hardcore raid.
    // </summary>
    TeamCompletedHardcoreRaid = 2724,

    // <summary>
    // You may take part in the %s hardcore raid up to %d times today.
    // </summary>
    HardcoreRaidParticipationLimit = 2725,

    // <summary>
    // You have reached your daily limit and cannot take part in the %s hardcore raid any more.
    // </summary>
    HardcoreRaidDailyLimitReached = 2726,

    // <summary>
    // The Order of Heroes effect is active.
    // </summary>
    OrderOfHeroesEffectActive = 2727,

    // <summary>
    // The Order of Discipline effect is active.
    // </summary>
    OrderOfDisciplineEffectActive = 2728,

    // <summary>
    // You receive an additional box because of the effect.
    // </summary>
    AdditionalBoxReward = 2729,

    // <summary>
    // You are now the leader of the hardcore raid. Invite members.
    // </summary>
    HardcoreRaidLeader = 2730,

    // <summary>
    // Would you like to create the hardcore raid map?
    // </summary>
    CreateHardcoreRaidMap = 2731,

    // <summary>
    // You can only start a hardcore raid with a complete team.
    // </summary>
    HardcoreRaidFullTeamRequired = 2732,

    // <summary>
    // All raid members should be on the same map at the start.
    // </summary>
    RaidMembersSameMapRequired = 2733,

    // <summary>
    // You have dealt the boss the minimum damage necessary to earn a reward.
    // </summary>
    MinimumDamageForReward = 2734,

    // <summary>
    // You receive an additional token because of the effect.
    // </summary>
    AdditionalTokenReward = 2735,
    ...
    // </summary>
    ShellUpgradeSolventAlreadyUsed = 2747,

    // <summary>
    // The shell upgrade level has been reduced and the most recently upgraded effect has been downgraded.
    // </summary>
    ShellUpgradeLevelReduced = 2748,

    // <summary>
    // Do you want to reduce the shell upgrade level? This would downgrade the following effect:
    // </summary>
    ShellUpgradeLevelReductionConfirm = 2749,

    // <summary>
    // The shell upgrade level (%s) has been reduced to +%d and the effect indicated has been downgraded.
    // </summary>
    ShellUpgradeLevelReducedEffectDowngraded = 2750,

    // <summary>
    // The shell upgrade can only be applied to champion level equipment.
    // </summary>
    ShellUpgradeChampionLevelRequired = 2751,

    // <summary>
    // If you don't earn any contribution points within %d minutes, you will be kicked out of Glacernon.
    // </summary>
    GlacernonKickWarning = 2752,
    ...
    // </summary>
    OrderOfFrozenKingBuffActive = 2754,

    // <summary>
    // The Order of the Frozen Conqueror buff is active.
    // </summary>
    OrderOfFrozenConquerorBuffActive = 2755,

    // <summary>
    // The Order of the Frozen Protector buff is active.
    // </summary>
    OrderOfFrozenProtectorBuffActive = 2756,

    // <summary>
    // You must be champion level %d or above to enter this region.
    // </summary>
    ChampionLevelRequired = 2757,

    // <summary>
    // Requires %d contribution points. Do you want to enter the hardcore raid?
    // </summary>
    HardcoreRaidContributionRequired = 2758,

    // <summary>
    // Amarok's Hideout is closed.
    // </summary>
    AmaroksHideoutClosed = 2760,

    // <summary>
    // Amarok's Hideout is open.
    // </summary>
    AmaroksHideoutOpen = 2761,

    // <summary>
    // %d minutes remain to explore Amarok's Hideout.
    // </summary>
    AmaroksHideoutTimeRemaining = 2762,

    // <summary>
    // The entrance to Amarok's Hideout is closed.
    // </summary>
    AmaroksHideoutEntranceClosed = 2763,

    // <summary>
    // You cannot enter Amarok's Hideout as the maximum number of players has been reached.
    // </summary>
    AmaroksHideoutMaxPlayersReached = 2764,

    // <summary>
    // I shall allow you to challenge me again. -Amarok-
    // </summary>
    AmarokChallengeAgain = 2765,

    // <summary>
    // Amarok's Curse makes it impossible to run away.
    // </summary>
    AmaroksCurseNoEscape = 2766,

    // <summary>
    // Respawn at the entrance to Amarok's Hideout.
    // </summary>
    RespawnAtAmaroksHideoutEntrance = 2767,
    ...
    // </summary>
    IncreaseSpecialistCardUpgradeTo9Prompt = 2769,

    // <summary>
    // The specialist card's upgrade level has been increased to 9.
    // </summary>
    SpecialistCardUpgradeIncreasedTo9 = 2770,
}